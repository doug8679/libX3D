...
public class LocalFog :  X3DChildNode, X3DFogObject {
    private static System.Xml.XmlQualifiedName typeName = new System.Xml.XmlQualifiedName("LocalFog", "");
    ...
    protected override void ReadAttributesXml(XmlReader reader) {
        ...
        _enabled = bool.Parse(reader["enabled"] ?? "true");
    }
    ...
    protected override void WriteAttributesXml(XmlWriter writer) {
        ...
        writer.WriteAttributeString("visibilityRange", VisibilityRange.ToString(CultureInfo.InvariantCulture));
    }
